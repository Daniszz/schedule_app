...
import { Play, X, HelpCircle, Save, Edit, Plus } from "lucide-react";
...
export default function ControlPanel({
  ...
  const handleSaveAsNew = () => {
    // Create a new schedule with current parameters
    handleCreateSchedule();
  };
            ...
            {activeTab === "setup" && (
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  {!currentSchedule ? (
                    // No schedule exists - show Save Schedule
                    <button
                    ...
                    // Schedule exists - show Update and Save as New
                    <>
                      <button
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  {currentSchedule ? (
                    ...
                    <div className="text-xs text-center text-gray-500 p-4">
                      Please save a schedule first in the Setup tab
                    </div>
                  )}
                </div>
